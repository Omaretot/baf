...
public OnFilterScriptInit()
{
	print(" |///////////////////////////////////////////////////////////////////////////| ");
	print(" |---------------------------------------------------------------------------| ");
	print(" |            Badmin v1.0 por bruunosoniico cargado exitosamente!            | ");
	print(" |---------------------------------------------------------------------------| ");
	print(" |///////////////////////////////////////////////////////////////////////////| ");
	return 1;
}
...
public OnFilterScriptExit()
{
	print(" |///////////////////////////////////////////////////////////////////////////| ");
	print(" |---------------------------------------------------------------------------| ");
	print(" |                       Badmin v1.0 por bruunosoniico                       | ");
	print(" |---------------------------------------------------------------------------| ");
	print(" |///////////////////////////////////////////////////////////////////////////| ");
	return 1;
}
...
public OnPlayerText(playerid, text[])
{
    ...
    if(dini_Exists(archivo))
    {
        ...
        {
     		SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Debes ingresar para poder hablar. Usa /ingreso [Contraseña].");
            return 0;
		}
	}
	else if(!dini_Exists(archivo))
	{
		SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Debes ingresar para poder hablar. Como no estas registrado, primero usa /registro [Contraseña].");
		return 0;
	}
	if(Callado[playerid] == 1)
	{
	    SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}No puedes hablar, ya que te han echo callar.");
	    return 0;
	}
	new string[256];
...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	if (strcmp("/ayuda", cmd, true) == 0)
	{
		...
		SendClientMessage(playerid, COLOR_CELESTE, "Has pedido ayuda, por lo tanto aqui tienes un poco de informacion:");
		SendClientMessage(playerid, COLOR_CELESTE, "Para registrarte, usa /registro [contraseña].");
		SendClientMessage(playerid, COLOR_CELESTE, "Para ingresar, usa /ingreso [contraseña].");
		SendClientMessage(playerid, COLOR_CELESTE, "Para cambiar tu contraseña, usa /cambiarcontra [nueva contraseña].");
		SendClientMessage(playerid, COLOR_CELESTE, "Para ver tus estadisticas, usa /estadisticas.");
		SendClientMessage(playerid, COLOR_CELESTE, "Para reportar a un usuario, usa /reportar [id] [razon].");
		SendClientMessage(playerid, COLOR_CELESTE, "Para guardar una posicion usa /guardarpos, y luego puedes usar /cargarpos para cargarla.");
		return 1;
	}
	if (strcmp("/estadisticas", cmd, true) == 0)
	{
		...
		GetPlayerName(playerid, usuario, sizeof(usuario));
		format(archivo, sizeof(archivo), "Badmin/Usuarios/%s.ini", usuario);
		format(string1, sizeof(string1), "Tu usuario es %s y tus datos son los siguientes:", usuario);
		format(string2, sizeof(string2), "Contraseña: %s", dini_Get(archivo, "Contraseña"));
		format(string3, sizeof(string3), "Nivel Admin: %d", dini_Int(archivo, "NivelAdmin"));
		format(string4, sizeof(string4), "Asesinatos: %d", dini_Int(archivo, "Asesinatos"));
		format(string5, sizeof(string5), "Muertes: %d", dini_Int(archivo, "Muertes"));
		format(string6, sizeof(string6), "Puntaje: %d", GetPlayerScore(playerid));
		format(string7, sizeof(string7), "Dinero: %d", GetPlayerMoney(playerid));
		format(string8, sizeof(string8), "Posicion guardada: %f, %f, %f, %f.", dini_Int(archivo, "PosGuardada(X)"), dini_Int(archivo, "PosGuardada(Y)"), dini_Int(archivo, "PosGuardada(Z)"), dini_Int(archivo, "PosGuardada(Angulo)"));
		SendClientMessage(playerid, COLOR_CELESTE, string1);
		SendClientMessage(playerid, COLOR_CELESTE, string2);
		SendClientMessage(playerid, COLOR_CELESTE, string3);
		SendClientMessage(playerid, COLOR_CELESTE, string4);
		SendClientMessage(playerid, COLOR_CELESTE, string5);
		SendClientMessage(playerid, COLOR_CELESTE, string6);
		SendClientMessage(playerid, COLOR_CELESTE, string7);
		SendClientMessage(playerid, COLOR_CELESTE, string8);
		return 1;
	}
	if (strcmp("/reportar", cmd, true) == 0)
	{
	    new tmp1[256], tmp2[256], nombrejugador[MAX_PLAYER_NAME], nombrereportado[MAX_PLAYER_NAME], string[256], reportadoid;
	    {
	        ...
	        if (!strlen(tmp1) ||!strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/reportar [ID] [Razon]");
	        ...
	        SendClientMessage(playerid, COLOR_VERDE, "Mensaje enviado a los administradores conectados.");
	        EnviarReporte(string);
	    }
	    return 1;
	}
	if (strcmp("/online", cmd, true) == 0)
	{
		new cantidadadmins;
	...
	if (strcmp("/guardarpos", cmd, true) == 0)
	{
	    if (Ingreso[playerid] == 1)
	    {
			...
			SendClientMessage(playerid, COLOR_VERDE, "Posicion guardada exitosamente!");
			PlayerPlaySound(playerid, 1057, 0.0, 0.0, 0.0);
		}
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "Para guardar una posicion, debes estar registrado. Usa /registro [Contraseña] para registrarte.");
		return 1;
	}
	if (strcmp("/cargarpos", cmd, true) == 0)
	{
	    if (Ingreso[playerid] == 1)
	    {
			...
			GetPlayerName(playerid, usuario, sizeof(usuario));
			format(archivo, sizeof(archivo), "Badmin/Usuarios/%s.ini", usuario);
			if (dini_Int(archivo, "PosGuardada(X)") == 0 || dini_Int(archivo, "PosGuardada(Y)") == 0 || dini_Int(archivo, "PosGuardada(Z)") == 0 || dini_Int(archivo, "PosGuardada(Angulo)") == 0) return SendClientMessage(playerid, COLOR_CRIMSON2, "No has guardado ninguna posicion aun. Para guardar una, usa /guardarpos");
			...
			SendClientMessage(playerid, COLOR_VERDE, "Posicion cargada exitosamente!");
			PlayerPlaySound(playerid, 1057, 0.0, 0.0, 0.0);
		}
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Para cargar una posicion, debes estar registrado. Usa /registro [Contraseña] para registrarte.");
		return 1;
	}
	if (strcmp("/registro", cmd, true) == 0)
	{
		...
		GetPlayerName(playerid, usuario, sizeof(usuario));
		format(archivo, sizeof(archivo), "Badmin/Usuarios/%s.ini", usuario);
        if (dini_Exists(archivo)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Tu nombre ya se encuentra registrado. Usa /ingreso [contraseña] para ingresar.");
        if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/registro [Contraseña].");
        if (strlen(tmp) < 4 || strlen(tmp) > 12) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Su contraseña debe contener entre 4 y 12 caracteres.");
		dini_Create(archivo);
	...
	if (strcmp("/ingreso", cmd, true) == 0)
	{
	    ...
	    GetPlayerName(playerid, usuario, sizeof(usuario));
		format(archivo, sizeof(archivo), "Badmin/Usuarios/%s.ini", usuario);
		if (Ingreso[playerid] == 1) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Ya te encuentras identificado.");
        if (!dini_Exists(archivo)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Tu nombre no se encuentra registrado. Usa /registro [contraseña] para registrarte.");
        if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/ingreso [Contraseña].");
		...
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "Contraseña incorrecta.");
		return 1;
	}
	if (strcmp("/cambiarcontra", cmd, true) == 0)
	{
	    if (Ingreso[playerid] == 1)
	    {
			new tmp[256], usuario[MAX_PLAYER_NAME], archivo[256], string[256];
			...
			GetPlayerName(playerid, usuario, sizeof(usuario));
			format(archivo, sizeof(archivo), "Badmin/Usuarios/%s.ini", usuario);
			if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/cambiarcontra [Nueva contraseña].");
        	if (strlen(tmp) < 4 || strlen(tmp) > 12) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Su contraseña debe contener entre 4 y 12 caracteres.");
			dini_Set(archivo, "Contraseña", cmdtext[15]);
			Ingreso[playerid] = 0;
			format(string, sizeof(string), "[BAF] {FFFFFF}Tu contraseña a sido cambiada con exito! Usa /ingreso %s para ingresar nuevamente.", cmdtext[15]);
			SendClientMessage(playerid, COLOR_VERDE_OSCURO, string);
			PlayerPlaySound(playerid, 1057, 0.0, 0.0, 0.0);
		}
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Para cambiar tu contraseña, debes estar registrado. Usa /registro [contraseña] para registrarte.");
		return 1;
	}
	...
	if (strcmp(cmd, "/acomandos", true) == 0)
	{
		...
		{
			SendClientMessage(playerid, COLOR_AZUL, "Comandos de administrador:");
			SendClientMessage(playerid, COLOR_AZUL, "Administrador nivel 1: /vvida, /vreparar, /vdestruir, /vnitro, /vcolor.");
		}
		else if (NivelAdmin[playerid] == 2)
		{
			SendClientMessage(playerid, COLOR_AZUL, "Comandos de administrador:");
			SendClientMessage(playerid, COLOR_AZUL, "Administrador nivel 1: /puntuaje, /dardinero, /blindaje, /puntaje, /dardinero, /dararma, /color.");
			SendClientMessage(playerid, COLOR_AZUL, "Administrador nivel 2: /anuncio, /vvida, /vreparar, /vdestruir, /vnitro, /vcolor.");
		}
		else if (NivelAdmin[playerid] == 3)
		{
			SendClientMessage(playerid, COLOR_AZUL, "Comandos de administrador:");
			SendClientMessage(playerid, COLOR_AZUL, "Administrador nivel 1: /adecir, /vida, /blindaje, /puntaje, /dardinero, /dararma, /color.");
			SendClientMessage(playerid, COLOR_AZUL, "Administrador nivel 2: /anuncio, /adecir, /vida, /blindaje, /puntaje, /dardinero, /dararma, /color.");
			SendClientMessage(playerid, COLOR_AZUL, "Administrador nivel 3: /espiar, /congelar, /descongelar, t, /traer, /limpiar, /mundo, /cambiarinterior, /encarcelar, /desencarcelar.");
		}
		else if (NivelAdmin[playerid] == 4)
		{
			...
			SendClientMessage(playerid, COLOR_AZUL, "Administrador nivel 1: /adecir, /vida, /blindaje, /puntaje, /dardinero, /dararma, /color.");
			SendClientMessage(playerid, COLOR_AZUL, "Administrador nivel 2: /anuncio, /vvida, /vreparar, /vdestruir, /vnitro, /vcolor.");
			SendClientMessage(playerid, COLOR_AZUL, "Administrador nivel 3: /espiar, /congelar, /descongelar, /ir, /traer, /limpiar, /mundo, /cambiarinterior, /encarcelar, /desencarcelar.");
			SendClientMessage(playerid, COLOR_AZUL, "Administrador nivel 4: /advertir, /callar, /v, /skin, /hora, /clima.");
		}
		else if (NivelAdmin[playerid] == 5)
		{
			SendClientMessage(playerid, COLOR_AZUL, "Comandos de administrador:");
			SendClientMessage(playerid, COLOR_AZUL, "Administrador nivel 1: /adecir, /vida, /blindaje, /puntaje, /mandardinero, /dararma, /color.");
			SendClientMessage(playerid, COLOR_AZUL, "Administrador nivel 2: /anuncio, /cvida, /creparar, /cdestruir, /cnitro, /ccolor.");
			SendClientMessage(playerid, COLOR_AZUL, "Administrador nivel 3: /espiar, /congelar, /descongelar, /ir, /traer, /limpiar, /mundo, /cambiarinterior, /encarcelar, /desencarcelar.");
			SendClientMessage(playerid, COLOR_AZUL, "Administrador nivel 4: /advertir, /callar, /v, /skins, /hora, /clima.");
			SendClientMessage(playerid, COLOR_AZUL, "Administrador nivel 5: /kickear, /banear, /cdios, /nombre.");
		}
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Necesitas ser administrador para usar este comando.");
		return 1;
	}
	if (strcmp(cmd, "/adecir", true) == 0)
	{
		if (NivelAdmin[playerid] == 1 || NivelAdmin[playerid] == 2 || NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp = strtok(cmdtext, idx);
			if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/adecir [Texto].");
			GetPlayerName(playerid, nombre, MAX_PLAYER_NAME);
			format(string, sizeof(string), "[Admin] %s: %s", nombre, cmdtext[7]);
			SendClientMessageToAll(COLOR_AQUA, string);
		}
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Necesitas ser administrador nivel 1 para usar este comando.");
		return 1;
	}
	if (strcmp(cmd, "/vida", true) == 0)
	{
		if (NivelAdmin[playerid] == 1 || NivelAdmin[playerid] == 2 || NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp1 = strtok(cmdtext, idx);
			tmp2 = strtok(cmdtext, idx);
			if (!strlen(tmp1) || !strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/vida [ID] [Cantidad].");
			jugador = strval(tmp1);
			admin = playerid;
			...
			else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}El jugador no se encuentra conectado.");
		}
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Necesitas ser administrador nivel 1 para usar este comando.");
		return 1;
	}
	if (strcmp(cmd, "/blindaje", true) == 0)
	{
		if (NivelAdmin[playerid] == 1 || NivelAdmin[playerid] == 2 || NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp1 = strtok(cmdtext, idx);
			tmp2 = strtok(cmdtext, idx);
			if (!strlen(tmp1) || !strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/blindaje [ID] [Cantidad].");
			jugador = strval(tmp1);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
	...
	if (strcmp(cmd, "/puntaje", true) == 0)
	{
		if (NivelAdmin[playerid] == 1 || NivelAdmin[playerid] == 2 || NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp1 = strtok(cmdtext, idx);
			tmp2 = strtok(cmdtext, idx);
			if (!strlen(tmp1) || !strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/puntaje [ID] [Cantidad].");
			jugador = strval(tmp1);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
	...
	if (strcmp(cmd, "/escuchar", true) == 0)
	{
		if(NivelAdmin[playerid] < 5) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Debes tener administrador nivel 5 para usar este comando.");
	...
	if (strcmp(cmd, "/mandardinero", true) == 0)
	{
		if (NivelAdmin[playerid] == 1 || NivelAdmin[playerid] == 2 || NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp1 = strtok(cmdtext, idx);
			tmp2 = strtok(cmdtext, idx);
			if (!strlen(tmp1) || !strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/dardinero [ID] [Cantidad].");
			if (strval(tmp2) < 100 || strval(tmp2) > 1000000) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Debes dar entre $100 y $1000000.");
			jugador = strval(tmp1);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
	...
	if (strcmp(cmd, "/dararma", true) == 0)
	{
		if (NivelAdmin[playerid] == 1 || NivelAdmin[playerid] == 2 || NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			if (!strlen(tmp1) || !strlen(tmp2) || !strlen(tmp3)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/dararma [ID] [Arma] [Municion].");
			jugador = strval(tmp1);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
	...
	if (strcmp(cmd, "/color", true) == 0)
	{
		if (NivelAdmin[playerid] == 1 || NivelAdmin[playerid] == 2 || NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp1 = strtok(cmdtext, idx);
			tmp2 = strtok(cmdtext, idx);
			if (!strlen(tmp1) || !strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/color [ID] [ID-Color].");
			jugador = strval(tmp1);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
	...
	if (strcmp(cmd, "/anuncio", true) == 0)
	{
		if (NivelAdmin[playerid] == 2 || NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			new tmp[256];
			tmp = strtok(cmdtext, idx);
			if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/anuncio [Texto].");
			GameTextForAll(cmdtext[9], 5000, 3);
		}
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Necesitas ser administrador nivel 2 para usar este comando.");
		return 1;
	}
	if (strcmp(cmd, "/cvida", true) == 0)
	{
		if (NivelAdmin[playerid] == 2 || NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp1 = strtok(cmdtext, idx);
			tmp2 = strtok(cmdtext, idx);
			if (!strlen(tmp1) || !strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/vvida [ID] [Cantidad].");
			jugador = strval(tmp1);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
	...
	if (strcmp(cmd, "/creparar", true) == 0)
	{
		if (NivelAdmin[playerid] == 2 || NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			new tmp[256], jugador, admin, string1[256], string2[256], nombrejugador[MAX_PLAYER_NAME], nombreadmin[MAX_PLAYER_NAME];
			tmp = strtok(cmdtext, idx);
			if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/vreparar [ID].");
			jugador = strval(tmp);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
			if (IsPlayerConnected(jugador))
			{
				...
				else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}El jugador no se encuentra en un vehiculo.");
			}
			else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}El jugador no se encuentra conectado.");
		}
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Necesitas ser administrador nivel 2 para usar este comando.");
	...
	if (strcmp(cmd, "/cdestruir", true) == 0)
	{
		if (NivelAdmin[playerid] == 2 || NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			new tmp1[256], jugador, admin, string1[256], string2[256], nombrejugador[MAX_PLAYER_NAME], nombreadmin[MAX_PLAYER_NAME];
			tmp1 = strtok(cmdtext, idx);
			if (!strlen(tmp1)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/vdestruir [ID].");
			jugador = strval(tmp1);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
		...
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Necesitas ser administrador nviel 2 para usar este comando.");
		return 1;
	}
	if (strcmp(cmd, "/cflip", true) == 0)
	{
		if (NivelAdmin[playerid] == 2 || NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp = strtok(cmdtext, idx);
			if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/vflip [ID].");
			jugador = strval(tmp);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
	...
	if (strcmp(cmd, "/cnitro", true) == 0)
	{
		if (NivelAdmin[playerid] == 2 || NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			new tmp[256], jugador, admin, string1[256], string2[256], nombrejugador[MAX_PLAYER_NAME], nombreadmin[MAX_PLAYER_NAME];
			tmp = strtok(cmdtext, idx);
			if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/vnitro [ID].");
			jugador = strval(tmp);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
	...
	if (strcmp(cmd, "/ccolor", true) == 0)
	{
		if (NivelAdmin[playerid] == 2 || NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp2 = strtok(cmdtext, idx);
			tmp3 = strtok(cmdtext, idx);
			if (!strlen(tmp1) || !strlen(tmp2) || strlen(tmp3)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/vcolor [ID] [Color1] [Color2].");
			jugador = strval(tmp1);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
    ...
    if (strcmp(cmd, "/espiar", true) == 0)
	{
		if (NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
		    ...
		    {
				tmp = strtok(cmdtext, idx);
				if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/espiar [ID]. Para dejar de espiar usa /espiar nuevamente.");
				jugador = strval(tmp);
				admin = playerid;
				if (strval(tmp) == admin) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}No puedes espiarte a ti mismo.");
				if (IsPlayerConnected(jugador))
				{
				    Espiando[playerid] = 1;
					PlayerPlaySound(admin, 1057, 0.0, 0.0, 0.0);
			...
			{
			    if (strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/espiar para dejar de espiar.");
			    Espiando[admin] = 0;
		...
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Necesitas ser administrador nivel 3 para usar este comando.");
		return 1;
 }
	if (strcmp(cmd, "/congelar", true) == 0)
	{
		if (NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			jugador = strval(tmp1);
			admin = playerid;
			if (!strlen(tmp1) || !strlen(tmp2) || !strlen(tmp3)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/congelar [ID] [Minutos] [Razon].");
        	if (strval(tmp1) == admin) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}No puedes congelarte a ti mismo.");
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
			minutos = strval(tmp2);
			if (IsPlayerConnected(jugador))
			{
			    if (Congelado[jugador] == 1) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}El jugador se encuentra congelado.");
			    Congelado[jugador] = 1;
	...
	if (strcmp(cmd, "/descongelar", true) == 0)
	{
		if (NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			jugador = strval(tmp);
			admin = playerid;
			if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/descongelar [ID].");
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
			if (IsPlayerConnected(jugador))
			{
			    if (Congelado[jugador] == 0) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}El jugador no se encuentra congelado.");
			    Congelado[jugador] = 0;
	...
	if (strcmp(cmd, "/ir", true) == 0)
	{
		if (NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp = strtok(cmdtext, idx);
			if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/ir [ID].");
			jugador = strval(tmp);
			admin = playerid;
			vehiculo = GetPlayerVehicleID(admin);
			if (strval(tmp) == admin) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}No puedes ir hacia ti mismo.");
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
	...
	if (strcmp(cmd, "/traer", true) == 0)
	{
		if (NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			new tmp[256], jugador, admin, vehiculo, string1[256], string2[256], nombrejugador[MAX_PLAYER_NAME], nombreadmin[MAX_PLAYER_NAME], Float:x, Float:y, Float:z, Float:angulo;
			tmp = strtok(cmdtext, idx);
			if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/traer [ID].");
			jugador = strval(tmp);
			admin = playerid;
			vehiculo = GetPlayerVehicleID(jugador);
			if (strval(tmp) == admin) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}No puedes traerte a ti mismo.");
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
			GetPlayerPos(admin, Float:x, Float:y, Float:z);
			GetPlayerFacingAngle(admin, Float:angulo);
	...
	if (strcmp(cmd, "/limpiar", true) == 0)
	{
	    if (NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
	    {
	 	   ...
	 	   SendClientMessageToAll(COLOR_CRIMSON2, " ");
	 	   SendClientMessageToAll(COLOR_CRIMSON2, " ");
	 	   SendClientMessageToAll(COLOR_CRIMSON2, " ");SendClientMessageToAll(COLOR_CRIMSON2, " ");
	 	   SendClientMessageToAll(COLOR_CRIMSON2, " ");
	 	   SendClientMessageToAll(COLOR_CRIMSON2, " ");
	 	   SendClientMessageToAll(COLOR_CRIMSON2, " ");
	 	   SendClientMessageToAll(COLOR_CRIMSON2, " ");
		...
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Necesitas ser administrador nivel 4 para usar este comando.");
		return 1;
	}
	if (strcmp(cmd, "/mundo", true) == 0)
	{
		if (NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp1 = strtok(cmdtext, idx);
			tmp2 = strtok(cmdtext, idx);
			if (!strlen(tmp1) || !strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/mundo [ID] [Mundo].");
			jugador = strval(tmp1);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
	...
	if (strcmp(cmd, "/advertir", true) == 0)
	{
		if (NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp1 = strtok(cmdtext, idx);
			tmp2 = strtok(cmdtext, idx);
			if (!strlen(tmp1) || !strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/advertir [ID] [Razon].");
			jugador = strval(tmp1);
			admin = playerid;
			if (strval(tmp1) == admin) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}No puedes advertirte a ti mismo.");
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
			if (IsPlayerConnected(jugador))
			{
	...
	if (strcmp(cmd, "/callar", true) == 0)
	{
		if (NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp1 = strtok(cmdtext, idx);
			tmp2 = strtok(cmdtext, idx);
			if (!strlen(tmp1) || !strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/callar [ID] [Razon]. Para que deje de estar callado, usa /callar [ID].");
			jugador = strval(tmp1);
			admin = playerid;
			if (strval(tmp1) == admin) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}No puedes callarte a ti mismo.");
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
			if (IsPlayerConnected(jugador))
			{
	...
	if (strcmp(cmd, "/kickear", true) == 0)
	{
		if (NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			jugador = strval(tmp1);
			admin = playerid;
			if (!strlen(tmp1) || !strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/kickear [ID] [Razon].");
        	if (strval(tmp1) == admin) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}No puedes kickearte a ti mismo.");
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
			if (IsPlayerConnected(jugador))
			{
	...
	if (strcmp(cmd, "/encarcelar", true) == 0)
	{
		if (NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			jugador = strval(tmp1);
			admin = playerid;
			if (!strlen(tmp1) || !strlen(tmp2) || !strlen(tmp3)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/encarcelar [ID] [Minutos] [Razon].");
        	if (strval(tmp1) == admin) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}No puedes encarcelarte a ti mismo.");
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
			minutos = strval(tmp2);
			if (IsPlayerConnected(jugador))
			{
			    if (Encarcelado[jugador] == 1) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}El jugador se encuentra encarcelado.");
	...
	if (strcmp(cmd, "/desencarcelar", true) == 0)
	{
		if (NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			jugador = strval(tmp);
			admin = playerid;
			if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Usa: /desencarcelar [ID].");
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
			if (IsPlayerConnected(jugador))
			{
			    if (Encarcelado[jugador] == 0) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}El jugador no se encuentra encarcelado.");
	...
	if (strcmp(cmd, "/mundo", true) == 0)
	{
		if (NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			if (IsPlayerConnected(jugador))
			{
				format(string1, sizeof(string1), "Has puesto a %s en el interior %d.", nombrejugador, mundo);
				format(string2, sizeof(string2), "%s  te ha puesto en el interior %d.", nombreadmin, mundo);
				SendClientMessage(admin, COLOR_AZUL, string1);
				SendClientMessage(jugador, COLOR_VERDE, string2);
				PlayerPlaySound(admin, 1057, 0.0, 0.0, 0.0);
				PlayerPlaySound(jugador, 1057, 0.0, 0.0, 0.0);
	...
	if (strcmp(cmd, "/c", true) == 0)
	{
		if (NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			if (!strlen(tmp1)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Debes especificar un jugador.");
			if (!strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Debes especificar un vehiculo.");
			jugador = strval(tmp1);
			admin = playerid;
			if (IsPlayerInAnyVehicle(jugador)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}El jugador se encuentra en un vehiculo.");
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
			GetPlayerPos(jugador, Float:x, Float:y, Float:z);
			GetPlayerFacingAngle(jugador, Float:angulo);
	...
	if (strcmp(cmd, "/skins", true) == 0)
	{
		if (NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp1 = strtok(cmdtext, idx);
			tmp2 = strtok(cmdtext, idx);
			if (!strlen(tmp1) || !strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/skind [ID] [Skin].");
			jugador = strval(tmp1);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
	...
	if (strcmp(cmd, "/hora", true) == 0)
	{
		if (NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp1 = strtok(cmdtext, idx);
			tmp2 = strtok(cmdtext, idx);
			if (!strlen(tmp1) || !strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/hora [Hora] [Minuto].");
			admin = playerid;
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
			hora = strval(tmp1);
			minuto = strval(tmp2);
	...
	if (strcmp(cmd, "/clima", true) == 0)
	{
		if (NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			tmp = strtok(cmdtext, idx);
			if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/clima [Clma].");
			admin = playerid;
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
			clima = strval(tmp);
	...
	if (strcmp(cmd, "/banear", true) == 0)
	{
		if (NivelAdmin[playerid] == 3 || NivelAdmin[playerid] == 4 || NivelAdmin[playerid] == 5)
		{
			...
			jugador = strval(tmp1);
			admin = playerid;
			if (!strlen(tmp1) || !strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/banear [ID] [Razon].");
			if (strval(tmp1) == admin) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}No puedes banearte a ti mismo.");
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
			if (IsPlayerConnected(jugador))
			{
	...
	if (strcmp(cmd, "/niveladmin", true) == 0)
	{
		if (NivelAdmin[playerid] == 5)
		{
			...
			tmp1 = strtok(cmdtext, idx);
			tmp2 = strtok(cmdtext, idx);
			if (!strlen(tmp1) || !strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/niveladmin [ID] [Nivel].");
			if (strval(tmp2) < 0 || strval(tmp2) > 5) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Debes elegir un nivel de 0 a 5.");
			if (strval(tmp1) == admin) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}No puedes cambiar tu propio nivel.");
			jugador = strval(tmp1);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
		...
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Necesitas ser administrador nivel 5 para usar este comando.");
		return 1;
	}
	if (strcmp(cmd, "/dios", true) == 0)
	{
	    if (NivelAdmin[playerid] == 5)
	    {
	        ...
	        tmp = strtok(cmdtext, idx);
	        if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/goku [ID]. Para desactivar el modo dios, usa /goku [ID] nuevamente.");
	        jugador = strval(tmp);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
	...
	if (strcmp(cmd, "/cdios", true) == 0)
	{
	    if (NivelAdmin[playerid] == 5)
	    {
	        new tmp[256], jugador, admin, string1[256], string2[256], string3[256], string4[256], nombrejugador[MAX_PLAYER_NAME], nombreadmin[MAX_PLAYER_NAME], Float:vida;
	        tmp = strtok(cmdtext, idx);
	        if (!strlen(tmp)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/vdios [ID]. Para desactivar el modo dios, usa /vdios [ID] nuevamente.");
	        jugador = strval(tmp);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
	...
	if (strcmp("/jetpack", cmd, true) == 0)
	{
		...
		SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Has spawneado un jetpack");
		SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}No debes dejar el jetpack tirado o un recluta lo recogera y podría ser baneado");
		}
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Necesitas ser administrador nivel 5 para usar este comando");
		return 1;
	}
	if (strcmp("/nombreoff", cmd, true) == 0)
	{
		if(NivelAdmin[playerid] == 5)
			{
				ShowNameTags(0);
				SendClientMessageToAll(COLOR_CRIMSON2, "[BAF] {FFFFFF}Los nombres de los jugadores se han ocultado");
			}
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Necesitas ser administrador nivel 5 para usar este comando");
		return 1;
	}
	if (strcmp("/nombreon", cmd, true) == 0)
	{
		if(NivelAdmin[playerid] == 5)
			{
			ShowNameTags(1);
			SendClientMessageToAll(COLOR_CRIMSON2, "[BAF] {FFFFFF}Los nombres de los jugadores se han restablecido");
			}
		else return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Necesitas ser administrador nivel 5 para usar este comando");
		return 1;
	}
	...
	if (strcmp(cmd, "/nombre", true) == 0)
	{
		if (NivelAdmin[playerid] == 5)
		{
			...
			tmp1 = strtok(cmdtext, idx);
			tmp2 = strtok(cmdtext, idx);
			if (!strlen(tmp1) || !strlen(tmp2)) return SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}/nombre [ID] [Nombre].");
			jugador = strval(tmp1);
			admin = playerid;
			GetPlayerName(jugador, nombrejugador, sizeof(nombrejugador));
			GetPlayerName(admin, nombreadmin, sizeof(nombreadmin));
...
public OnPlayerRequestSpawn(playerid)
{
    ...
    if(dini_Exists(archivo))
    {
        if(Ingreso[playerid] == 0)
        {
     		SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Debes ingresar antes de spawnear. Usa /ingreso [Contraseña].");
            return 0;
		}
	}
	else if(!dini_Exists(archivo))
	{
		SendClientMessage(playerid, COLOR_CRIMSON2, "[BAF] {FFFFFF}Debes ingresar antes de spawnear. Como no estas registrado, primero usa /registro [Contraseña].");
		return 0;
	}
	return 1;
}
